python STIR_demonstration_projector.py --initial_activity=187 --time_per_projection=40 \
--photon_multiplier=10 --photopeak_energy=150 --window_lower=75 --window_upper=225 \
--source_type="y90_frey" --collimator="ma-megp" --kev_per_channel=25 \
--max_energy=2180 --mu_map_path="data/Y90/umap_zoomed.hv" \
--image_path="data/Y90/osem_reconstuction_postfilter_555.hv" \
