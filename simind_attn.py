...
def get_attenuation_coefficient(material, energy):
...
def hu_to_attenuation(image_array, photon_energy):
    # Constants
    ...
    mu_water = get_attenuation_coefficient('water', photon_energy)
    mu_bone = get_attenuation_coefficient('bone', photon_energy)
...
def attenuation_to_density(attenuation_array, photon_energy):
    # Convert photon_energy to MeV from keV
    photon_energy = photon_energy / 1000
